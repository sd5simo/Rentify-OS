          ...
          <div className="space-y-3">
            ...
            <div className="overflow-auto max-h-[80vh] rounded-xl bg-white p-8 text-[11px] text-black" style={{ fontFamily: "Arial, sans-serif" }}>
              <div className="flex justify-between border-b-2 border-gray-800 pb-4 mb-5">
                <div><p className="text-lg font-bold">Kharrazi</p><p className="text-xs text-gray-600">Location de Voitures</p><p className="text-xs text-gray-500">123 Avenue Mohammed V, Casablanca</p><p className="text-xs text-gray-500">Tél: +212 522 123 456</p></div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="border border-gray-200 rounded p-3"><p className="font-bold text-xs border-b pb-1 mb-2 uppercase">Loueur</p><p className="font-semibold">Kharrazi Location de Voitures</p><p className="text-gray-600">Casablanca, Maroc</p></div>
              ...
              <div className="grid grid-cols-2 gap-8 mt-6">
                <div className="text-center"><p className="font-semibold text-xs mb-1">Signature du Loueur</p><div className="border-b-2 border-gray-400 mt-8 mb-1" /><p className="text-gray-500 text-[10px]">Kharrazi</p></div>
