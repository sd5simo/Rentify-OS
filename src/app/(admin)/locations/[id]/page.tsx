...
export default function LocationDetailPage() {
  ...
  // --- FONCTIONS POUR LE CONTRAT IMPRIMABLE ---
  ...
  return (
    <>
      {/* STYLE MAGIQUE POUR L'IMPRESSION 
        Ceci cache les menus de navigation et s'assure que le contrat prend tout l'écran
      */}
      <style>{`
        @media print {
      ...
      <div className="space-y-5 animate-fade-in print:hidden">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex gap-2 flex-shrink-0">
            {/* LE BOUTON D'IMPRESSION EXISTANT */}
      ...
      {/* =========================================================================
          PARTIE 2 : LE CONTRAT PDF (INVISIBLE À L'ÉCRAN, APPARAIT À L'IMPRESSION) 
          ========================================================================= */}
